...
class Translation
  ...
  MS_TRANSLATOR_PRIMARY_KEY      = "kAtUhkoaCaB3KdsCdpNSBwbPUTNszxQthgxm9S7OWq0"
  # クライアントID see: https://datamarket.azure.com/developer/applications/
  MS_TRANSLATOR_CLIENT_ID        = "soisoi"
  # クライアントID see: 顧客の秘密
  MS_TRANSLATOR_CLIENT_SECRET    = "af9Ezcs+mAvL/rnAp3bo+3PJpkXGcsnXZnOyWJySFOw="
  MS_TRANSLATOR_ACCESS_TOKEN_URL  = "https://datamarket.accesscontrol.windows.net/v2/OAuth2-13"
